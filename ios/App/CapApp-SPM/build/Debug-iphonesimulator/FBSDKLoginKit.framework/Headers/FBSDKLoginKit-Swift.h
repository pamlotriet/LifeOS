...
SWIFT_ENUM_FWD_DECL(NSUInteger, FBSDKLoginButtonTooltipBehavior)
SWIFT_ENUM_FWD_DECL(NSUInteger, FBSDKTooltipColorStyle)
SWIFT_ENUM_FWD_DECL(NSUInteger, FBSDKLoginTracking)
@class NSCoder;
...
SWIFT_ENUM_FWD_DECL(NSUInteger, FBSDKTooltipViewArrowDirection)
...
SWIFT_ENUM_FWD_DECL(NSInteger, FBSDKRefreshFallbackPolicy)
@class FBSDKProfile;
